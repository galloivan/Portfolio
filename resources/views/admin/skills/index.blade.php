...
<head>
    ...
    <title>Admin Dashboard | Manage Your Skills</title>
...
<header class="navy-navbar shadow-md fixed top-0 left-0 w-full z-50">
    <div class="container mx-auto flex justify-between items-center px-6">
        <h1 class="text-2xl font-bold sky-text">Admin Dashboard | Manage Your Skills</h1>
    </div>
</header>
...
<main class="container mx-auto pt-24 px-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold sky-text">Skills Management</h1>
        <a href="{{ route('admin.skills.create') }}" class="teal-btn shadow-md">
            + Add New Skill
        </a>
    </div>
        ...
        <table class="styled-table">
            ...
            @foreach ($skills as $skill)
                <tr>
                    ...
                    <td>{{ $skill->name }}</td>
                    <td>
                        <img src="{{ asset($skill->icon) }}" alt="{{ $skill->name }}" class="w-12 h-12 rounded">
                    </td>
                    <td class="text-center">
                        <a href="{{ route('admin.skills.edit', $skill->id) }}" class="edit-btn">Edit</a>
